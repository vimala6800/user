...
export class RequisitionClient implements IRequisitionClient {
  ...
  get(): Observable<RequisitionVm> {
    let url_ = (environment.base_url) + "/api/Requisition";
    //url_ = url_.replace(/[?&]$/, "");
  ...
  get2(id: string): Observable<FileResponse> {
    let url_ = (environment.base_url) + "/api/Requisition/{id}";
    if (id === undefined || id === null)
      throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
    url_ = url_.replace(/[?&]$/, "");
  ...
  update(id: string, command: UpdateRequisitionCommand): Observable<FileResponse> {
    let url_ = (environment.base_url) + "/api/Requisition/{id}";
    if (id === undefined || id === null)
      throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
...
export class RequisitionDto implements IRequisitionDto {
  ...
  requisitionSkills?: RequisitionSkillsDto[];
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.clientCountreyID = _data["clientCountreyID"];
      ...
      if (Array.isArray(_data["requisitionSkills"])) {
        this.requisitionSkills = [] as any;
        for (let requisitionSkills of _data["requisitionSkills"])
          this.requisitionSkills!.push(RequisitionSkillsDto.fromJS(requisitionSkills));
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data["clientCountreyID"] = this.clientCountreyID;
    ...
    if (Array.isArray(this.requisitionSkills)) {
      data["requisitionSkills"] = [];
      for (let requisitionSkills of this.requisitionSkills)
        data["requisitionSkills"].push(requisitionSkills.toJSON());
    }
    return data;
  }
}
...
export class UpdateRequisitionCommand implements IUpdateRequisitionCommand {
  requisitionID?: string;
  requisitionCode?: string;
  potentialNumber?: string;
  complexity?: string;
  ...
  constructor(data?: IUpdateRequisitionCommand) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property))
          (<any>this)[property] = (<any>data)[property];
...
export interface IUpdateRequisitionCommand {
  requisitionID?: string;
  requisitionCode?: string;
  potentialNumber?: string;
  complexity?: string;
